...
class AdminAppointmentsController extends ChangeNotifier {
  ...
  List<AdminAppointmentModel> get _filteredAppointments =>
      ...
      _filter.matches(a.status)&&
          (_selectedEmployeeId==null||a.employeeId==_selectedEmployeeId)&&
          _matchesSearch(a)
      ).toList();
  ...
  Future<void> loadAppointments({required String salonId}) async{
  ...
  Future<void> refresh() async{
    if(_salonId.isEmpty)return;
    await loadAppointments(salonId:_salonId);
  }
